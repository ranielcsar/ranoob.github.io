...
function scrollFunction() {
   ...
   if (document.body.scrollTop > 130 || document.documentElement.scrollTop > 130) 
   {
      ...
      document.querySelector(".cabecalho").style.background = "linear-gradient(to bottom right, #24252A, #333333)";
      ...
      document.querySelector(".cabecalho").style.background = "transparent";
